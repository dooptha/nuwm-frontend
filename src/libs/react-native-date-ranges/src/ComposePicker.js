...
export default class ComposePicker extends Component {
  ...
  renderButton = () => {
    const { customButton, customStyles } = this.props;
    ...
    return (
      ...
      >
        <Text style={[{ fontSize: 20 }, this.props.ButtonTextStyle, customStyles.mainText]}>
        ...
        <View>
          ...
          >
            <View stlye={{ flex: 1, flexDirection: 'column' }}>
              <View style={{ height: '90%', ...customStyles.sub }}>
                <DateRange
