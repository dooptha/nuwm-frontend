...
export default class Week extends Component {
  render() {
    ...
    moment.range(startOfWeek, endOfWeek).by('days', (day) => {
      ...
      const isDateStart = () => startDate && day.isSame(startDate, 'day');
      const isDateEnd = () => endDate && day.isSame(endDate, 'day');
      ...
      const styleText = [
        { ...styles.dayText, color: textColor },
        ...
        ? [styles.borderContainer,
          {
            borderRadius: 20,
            backgroundColor:
              selectedBgColor || styles.daySelected.backgroundColor,
          }]
        : styles.borderContainer;
      days.push(
        <TouchableOpacity
